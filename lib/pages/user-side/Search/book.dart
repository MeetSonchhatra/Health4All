    ...
    return SafeArea(
      ...
      body: Column(
        children: [
          ...
          BookName(id: widget.id.toString()),
          // Stack(
          //   children: [
          //     Card(
          //       elevation: 5,
...
class BookName extends StatefulWidget {
  ...
  final String id;
  @override
  State<BookName> createState() => _BookNameState();
}
...
class _BookNameState extends State<BookName> {
  ...
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<Fulldetail_Model>(
        future: fulldetailsApi().fulldetailsList(widget.id.toString()),
                        ...
                        child: SizedBox(
                          ...
                          child: Stack(
                            children: [
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        ...
                                        onChanged: (value) {
                                          ...
                                          horizontal: 8.14.w, vertical: 0.3.h),
                                      SizedBox(
                                        height: 1.h,
                                      ),
                                      const Divider(
                              ...
                              ).marginOnly(left: 10.w, right: 1.w, top: 27.7.h),
                            ],
                          ),
                        ),
                      );
